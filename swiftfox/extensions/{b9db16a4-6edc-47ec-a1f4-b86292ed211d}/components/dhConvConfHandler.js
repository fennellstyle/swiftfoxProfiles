...
ConvConfHandler.prototype.contractID="@downloadhelper.net/convconf-handler;1";
ConvConfHandler.prototype.classID=Components.ID("{2b554319-e7fb-420e-8f12-1bf88aa2848d}");
ConvConfHandler.prototype.QueryInterface=XPCOMUtils.generateQI([
...
if (XPCOMUtils.generateNSGetFactory)
    var NSGetFactory = XPCOMUtils.generateNSGetFactory([ConvConfHandler]);
else
    var NSGetModule = XPCOMUtils.generateNSGetModule([ConvConfHandler]);
