...
MP3Tunes.prototype.contractID="@downloadhelper.net/mp3tunes-manager;1";
MP3Tunes.prototype.classID=Components.ID("{59dd53ca-8989-4e95-bc7a-996e8592886e}");
MP3Tunes.prototype.QueryInterface=XPCOMUtils.generateQI([
                                       Components.interfaces.dhIMP3Tunes,
                                       ]);


if (XPCOMUtils.generateNSGetFactory)
    var NSGetFactory = XPCOMUtils.generateNSGetFactory([MP3Tunes]);
else
    var NSGetModule = XPCOMUtils.generateNSGetModule([MP3Tunes]);
