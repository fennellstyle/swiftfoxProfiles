...
DhMediaListMgr.prototype.contractID="@downloadhelper.net/media-list-manager";
DhMediaListMgr.prototype.classID=Components.ID("{55f8f6d3-9ac7-4046-b1bb-7c732e27d2d6}");
DhMediaListMgr.prototype.QueryInterface=XPCOMUtils.generateQI([
                                       Components.interfaces.nsITimerCallback,
                                       Components.interfaces.nsIObserver,
                                       Components.interfaces.dhIMediaListMgr
                                       ]);


if (XPCOMUtils.generateNSGetFactory)
    var NSGetFactory = XPCOMUtils.generateNSGetFactory([DhMediaListMgr]);
else
    var NSGetModule = XPCOMUtils.generateNSGetModule([DhMediaListMgr]);
