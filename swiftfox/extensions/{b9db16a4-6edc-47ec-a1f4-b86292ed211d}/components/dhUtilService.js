...
UtilService.prototype.contractID="@downloadhelper.net/util-service;1";
UtilService.prototype.classID=Components.ID("{dbd8dc72-2cdf-44ad-bf9a-5dc7a3fc3036}");
UtilService.prototype.QueryInterface=XPCOMUtils.generateQI([
                                       Components.interfaces.dhIUtilService,
                                       ]);

if (XPCOMUtils.generateNSGetFactory)
    var NSGetFactory = XPCOMUtils.generateNSGetFactory([UtilService]);
else
    var NSGetModule = XPCOMUtils.generateNSGetModule([UtilService]);
