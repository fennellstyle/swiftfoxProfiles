...
ConvertMgr.prototype.contractID="@downloadhelper.net/convert-manager-component";
ConvertMgr.prototype.classID=Components.ID("{5f4589e7-114b-4a4b-a63e-06ca7f22439d}");
ConvertMgr.prototype.QueryInterface=XPCOMUtils.generateQI([
                                       Components.interfaces.dhIConvertMgr,
                                       ]);


if (XPCOMUtils.generateNSGetFactory)
    var NSGetFactory = XPCOMUtils.generateNSGetFactory([ConvertMgr]);
else
    var NSGetModule = XPCOMUtils.generateNSGetModule([ConvertMgr]);
